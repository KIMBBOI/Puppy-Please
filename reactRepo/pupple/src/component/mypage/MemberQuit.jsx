...
const MemberQuit = () => {
    ...
    const handleQuitSubmit = (event) => {
        ...
        fetch("http://127.0.0.1:8080/app/member/quit", {
            method: "DELETE",
            ...
            <form onSubmit={handleQuitSubmit}>
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>비밀번호</td>
                            <td><input type="text" name="pwd" onChange={handleInputChange}/></td>
                        </tr>
                        <tr>
                            <td>비밀번호 확인</td>
                            <td><input type="text" name="pwd2" onChange={handleInputChange}/></td>
                        </tr>
                        <tr>
                            <td>생년월일</td>
